...
Namespace LFERP.Library.SampleManager.SamplePace
    ...
    Public Class SamplePaceControler
        ...
        Friend Function FillSamplePaceType(ByVal reader As IDataReader) As SamplePaceInfo
            ...
            '2014-08-06 袁毅龍
            objInfo.CVSName = reader("CVSName") 'FTP文件名
...
#Region "半成品條碼"
        ...
        Public Function SamplePaceBarCode_SEUpdate(ByVal SE_ID As String) As Boolean
            Try
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("SamplePaceBarCode_SEUpdate")
                dbComm.CommandTimeout = 0
                db.AddInParameter(dbComm, "@SE_ID", DbType.String, SE_ID)
                db.ExecuteNonQuery(dbComm)
                SamplePaceBarCode_SEUpdate = True
            Catch ex As Exception
                MsgBox(ex.Message)
                SamplePaceBarCode_SEUpdate = False
            End Try
        End Function

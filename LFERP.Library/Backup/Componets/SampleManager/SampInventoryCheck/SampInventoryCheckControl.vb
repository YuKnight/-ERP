Namespace LFERP.Library.SampleManager.SampInventoryCheck
    Public Class SampInventoryCheckControl
        ...
        Public Function SampleWareInventoryAnnal4_GetList(ByVal PM_M_Code As String, ByVal PS_NO As String, ByVal D_ID As String, ByVal StrD_IDM As String, ByVal StrD_IDN As String, ByVal StratDate As String, ByVal EndDate As String, ByVal C_D_IDM As String, ByVal C_D_IDN As String) As DataSet
            Try
                Dim ds As New DataSet
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                ...
                db.AddInParameter(dbComm, "@StratDate", DbType.String, StratDate)
                db.AddInParameter(dbComm, "@EndDate", DbType.String, EndDate)
                db.AddInParameter(dbComm, "@StrD_IDC", DbType.String, C_D_IDM)
                db.AddInParameter(dbComm, "@StrD_IDD", DbType.String, C_D_IDN)

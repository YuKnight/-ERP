Namespace LFERP.Library.NmetalSampleManager.NmetalSampleOrdersMain
    Public Class NmetalSampleOrdersMainInfo
        ...
        Private _SO_TypeName As String

        '2014-07-23  Mark
        Private _Manual_Number As String
        ...
        Public Sub New()
            ...
            _SO_Type = Nothing
            _SO_TypeName = Nothing

            '2014-07-23   Mark
            _Manual_Number = Nothing
        End Sub

        Public Property SO_TypeName() As String
            Get
                Return _SO_TypeName
            End Get
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Property Manual_Number() As String
            Get
                Return _Manual_Number
            End Get
            Set(ByVal value As String)

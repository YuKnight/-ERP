Namespace LFERP.Library.NmetalSampleManager.NmetalSampleSetting
    Public Class NmetalSampleSettingController
        Friend Function FillNmetalSampleSetting(ByVal reader As IDataReader) As NmetalSampleSettingInfo
            On Error Resume Next
            Dim objInfo As New NmetalSampleSettingInfo
        ...
        Public Function NmetalSampleSetting_GetList(ByVal U_ID As String) As List(Of NmetalSampleSettingInfo)
            Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
            Dim dbComm As DbCommand = db.GetStoredProcCommand("NmetalSampleSetting_GetList")
            db.AddInParameter(dbComm, "@U_ID", DbType.String, U_ID)
            Dim FeatureList As New List(Of NmetalSampleSettingInfo)
            Using reader As IDataReader = db.ExecuteReader(dbComm)
                While reader.Read
                    FeatureList.Add(FillNmetalSampleSetting(reader))
                End While
                Return FeatureList
            End Using
        End Function

        Public Function NmetalSampleSetting_Update(ByVal objinfo As NmetalSampleSettingInfo) As Boolean
            Try
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("NmetalSampleSetting_Update")
                ...
                NmetalSampleSetting_Update = True
            Catch ex As Exception
                MsgBox(ex.Message)
                NmetalSampleSetting_Update = False
            End Try
        End Function

        Public Function NmetalSampleSetting_Add(ByVal objInfo As NmetalSampleSettingInfo) As Boolean
            Try
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("NmetalSampleSetting_Add")
                db.AddInParameter(dbComm, "@U_ID", DbType.String, objInfo.U_ID)
                db.AddInParameter(dbComm, "@SampleOrdersBeginDate", DbType.DateTime, objInfo.SampleOrdersBeginDate)
                db.AddInParameter(dbComm, "@SampleOrdersCheck", DbType.String, objInfo.SampleOrdersCheck)
                db.AddInParameter(dbComm, "@SampleOrdersCreateUserID", DbType.String, objInfo.SampleOrdersCreateUserID)
                ...
                db.ExecuteNonQuery(dbComm)
                NmetalSampleSetting_Add = True
            Catch ex As Exception
                MsgBox(ex.Message)
                NmetalSampleSetting_Add = False
            End Try
        End Function
    End Class
End Namespace
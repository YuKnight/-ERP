Namespace LFERP.Library.Production.ProuctionWareOutA
    ...
    Public Class ProductionWareOutAInfo
        ...
        Private _PWO_InWareID As String
        Private _PWO_InName As String
        Private _PWO_InAction As String
        Private _PWO_InActionName As String
        Private _PWO_InAddDate As Date
        Private _PWO_InCheck As Boolean


        Sub New()
            _PWO_InName = Nothing
            _PWO_InWareID = Nothing
            _PWO_InAction = Nothing
            _PWO_InActionName = Nothing
            _PWO_InAddDate = Nothing
            _PWO_InCheck = Nothing
        ...
        End Sub
        Public Property PWO_InName() As String
            Get
                Return _PWO_InName
            End Get
            ...
            End Set
        End Property
        Public Property PWO_InWareID() As String
            Get
                Return _PWO_InWareID
            End Get
            Set(ByVal value As String)
                _PWO_InWareID = value
            End Set
        End Property
        Public Property PWO_InAction() As String
            Get
                Return _PWO_InAction
            End Get
            Set(ByVal value As String)
                _PWO_InAction = value
            End Set
        End Property
        Public Property PWO_InActionName() As String
            Get
                Return _PWO_InActionName
            End Get
            Set(ByVal value As String)
                _PWO_InActionName = value
            End Set
        End Property
        Public Property PWO_InAddDate() As Date
            Get
                Return _PWO_InAddDate
            End Get
            Set(ByVal value As Date)
                _PWO_InAddDate = value
            End Set
        End Property
        Public Property PWO_InCheck() As Boolean
            Get
                Return _PWO_InCheck
            End Get

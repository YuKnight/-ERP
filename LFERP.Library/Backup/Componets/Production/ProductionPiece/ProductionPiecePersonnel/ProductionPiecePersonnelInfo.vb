Namespace LFERP.Library.ProductionPiecePersonnel
    ...
    Public Class ProductionPiecePersonnelInfo
        ...
        Private _Per_NOName As String
        Private _Per_Class As String     '班制

        Private _KQMonth As String
        Private _KQClass As String
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Property KQMonth() As String
            Get
                Return _KQMonth
            End Get
            Set(ByVal value As String)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Property KQClass() As String
            Get
                Return _KQClass
            End Get
            Set(ByVal value As String)

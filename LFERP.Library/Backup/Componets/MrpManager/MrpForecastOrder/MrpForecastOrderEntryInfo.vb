...
#Region "字段和屬性"
        ...
        Private _PurchasedQty As Decimal
        Private _IsMrpOperation As Boolean
        Private _DeliveryQty As Decimal
...
#Region "初始化"
        ...
        Public Sub New()
            ...
            _M_Source = Nothing
            _DateCross = Nothing
            _IsMrpOperation = False
            _DeliveryQty = Nothing
            _PlanQty = Nothing
            _IsCheck = False
            _CheckDate = Nothing
...
#Region "實例"
        ...
        Public Property PlanQty() As Decimal
            ...
            End Set
        End Property
        Public Property DeliveryQty() As Decimal
            Get
                Return _DeliveryQty
            End Get
            Set(ByVal value As Decimal)
        ...
        Public Property IsMrpOperation() As Boolean
            Get
                Return _IsMrpOperation
            End Get
            Set(ByVal value As Boolean)
                _IsMrpOperation = value
            End Set
        End Property
        ...
        Public Property ForecastID() As String
            ...
            End Set
        End Property
        Public Property PurchasedQty() As Decimal
            Get
            ...
            End Set
        End Property
        Public Property MI_Qty() As Decimal
            Get
                Return _MI_Qty
            End Get
            Set(ByVal value As Decimal)

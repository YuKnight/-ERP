...
#Region "信息的填充"
        ...
        Friend Function FillMrpForecastOrder(ByVal reader As IDataReader) As MrpForecastOrderInfo
            ...
            If IsDBNull(reader("NeedQty")) = True Then
                objInfo.NeedQty = 0
            Else
                objInfo.NeedQty = reader("NeedQty")
            End If
            Return objInfo
        End Function
        ''' <summary>
...
#Region "查詢"
        ...
        ''' <remarks></remarks>
        Public Function MrpForecastOrder_GetList(ByVal ForecastID As String, ByVal date1 As Date, ByVal date2 As Date, ByVal CheckBit As String, ByVal MO_PlanType As String, ByVal StrCusterID As String, ByVal DisplayNum As Decimal) As List(Of MrpForecastOrderInfo)
        ...
        Public Function MrpForecastOrder_GetMONum() As String
            Try
                Dim MONum As String = String.Empty
                ...
                If MONum = String.Empty Then
                    NewForecastID = "FO" + Format(Now, "yyyyMM") + "0001"
                    Return NewForecastID
                    Exit Function
                End If
                If CInt(Format(Now, "yyyyMM")) <= CInt(MONum) Then
                    NewForecastID = "FO" + (CInt(MONum) + 1).ToString
                Else
                    NewForecastID = "FO" + Format(Now, "yyyyMM") + "0001"
                End If
                Return NewForecastID
        ...
        Public Function GetWeekInfo(ByVal StartNeedDate As Date, ByVal EndNeedDate As Date, ByVal CusterID As String, ByVal M_Code As String, ByVal MC_Source As String) As DataTable
            Try
        ...
        Public Function GetWeekAllProductionInfo(ByVal StartNeedDate As Date, ByVal EndNeedDate As Date, ByVal M_Code As String) As DataTable
            Try
                Dim ds As New DataSet
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("MrpOderEntryAllProductionWeek")
                db.AddInParameter(dbComm, "@StartNeedDate", DbType.Date, StartNeedDate)
                db.AddInParameter(dbComm, "@EndNeedDate", DbType.Date, EndNeedDate)
                db.AddInParameter(dbComm, "@M_Code", DbType.String, M_Code)
                ds = db.ExecuteDataSet(dbComm)
        ...
        Public Function GetWeekAllInfo(ByVal StartNeedDate As Date, ByVal EndNeedDate As Date, ByVal CusterID As String, ByVal M_Code As String, ByVal MC_Source As String) As DataTable
            Try
                Dim ds As New Dataset
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
        ...
        Public Function GetMonthInfo(ByVal StartNeedDate As Date, ByVal EndNeedDate As Date, ByVal CusterID As String, ByVal M_Code As String, ByVal MC_Source As String) As DataTable
            Try
                Dim ds As New DataSet
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
        ...
        Public Function GetMonthAllProductionInfo(ByVal StartNeedDate As Date, ByVal EndNeedDate As Date, ByVal M_Code As String) As DataTable
            Try
                Dim ds As New DataSet
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("MrpOderEntryAllProductionMonth")
                db.AddInParameter(dbComm, "@StartNeedDate", DbType.Date, StartNeedDate)
                db.AddInParameter(dbComm, "@EndNeedDate", DbType.Date, EndNeedDate)
        ...
        Public Function GetMonthAllInfo(ByVal StartNeedDate As Date, ByVal EndNeedDate As Date, ByVal CusterID As String, ByVal M_Code As String, ByVal MC_Source As String) As DataTable
            Try
                Dim ds As New DataSet
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
        ...
        Public Function GetWeekInfoChild(ByVal StartNeedDate As Date, ByVal EndNeedDate As Date, ByVal MO_CusterID As String, ByVal M_Code As String, ByVal MC_Source As String) As DataTable
            Try
                Dim ds As New DataSet
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
        ...
        Public Function GetWeekAllInfoChild(ByVal StartNeedDate As Date, ByVal EndNeedDate As Date, ByVal MO_CusterID As String, ByVal M_Code As String, ByVal MC_Source As String) As DataTable
            Try
                Dim ds As New DataSet
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
        ...
        Public Function GetMonthInfoChild(ByVal StartNeedDate As Date, ByVal EndNeedDate As Date, ByVal MO_CusterID As String, ByVal M_Code As String, ByVal MC_Source As String) As DataTable
            Try
                Dim ds As New DataSet
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
            ...
            End Try
        End Function
        Public Function GetMonthAllInfoChild(ByVal StartNeedDate As Date, ByVal EndNeedDate As Date, ByVal MO_CusterID As String, ByVal M_Code As String, ByVal MC_Source As String) As DataTable
            Try
                Dim ds As New DataSet
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
            ...
            End Try
        End Function
        Public Function MrpOderEntryAllCodeWeek_Out(ByVal StartNeedDate As Date, ByVal EndNeedDate As Date, ByVal MO_CusterID As String, ByVal M_Code As String, ByVal MC_Source As String) As DataTable
            Try
                Dim ds As New DataSet
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
            ...
            End Try
        End Function
        Public Function MrpOderEntryAllCodeMonth_Out(ByVal StartNeedDate As Date, ByVal EndNeedDate As Date, ByVal MO_CusterID As String, ByVal M_Code As String, ByVal MC_Source As String) As DataTable
            Try
                Dim ds As New DataSet
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
        ...
        Public Function MrpForecastOrder_GetDataTable() As DataTable
            Dim ds As New DataSet
            Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
            Dim dbComm As DbCommand = db.GetSqlStringCommand("select ForecastID  from MrpForecastOrder ")
            ds = db.ExecuteDataSet(dbComm)
            If ds.Tables.Count > 0 Then
                Return ds.Tables(0)
            Else
...
#Region "刪除"
        ...
        Public Function MrpForecastOrder_PreDelete(ByVal ForecastID As String) As Boolean
            Dim list As New List(Of String)
            list.Add("select MRP_ID from MrpInfo where MI_ForecastID like '" + ForecastID + "%'")
            list.Add("的需求運算中存在該預測單號(" + ForecastID + ")，無法刪除")

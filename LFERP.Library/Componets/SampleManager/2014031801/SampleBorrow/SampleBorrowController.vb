...
Namespace LFERP.Library.SampleManager.SampleBorrow
    ...
    Public Class SampleBorrowController
        ...
        Public Function SampleBorrow_GetList(ByVal BorrowID As String, ByVal D_ID As String, ByVal PS_NO As String, ByVal PM_M_Code As String, ByVal OutCardID As String, ByVal Where As String) As List(Of SampleBorrowInfo)
            Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
        ...
        Public Function SampleBorrowA_GetList(ByVal D_ID As String, ByVal PS_NO As String, ByVal PM_M_Code As String, ByVal OutCardID As String, ByVal Where As String) As List(Of SampleBorrowInfo)
            Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
        ...
        Public Function SampleBorrow_UpdateNoBorrowQty(ByVal BorrowID As String, ByVal NoBorrow_Qty As Integer) As Boolean
            Try
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("SampleBorrow_UpdateNoBorrowQty")
                db.AddInParameter(dbComm, "@BorrowID", DbType.String, BorrowID)
                If NoBorrow_Qty <> Nothing Then
                    db.AddInParameter(dbComm, "@NoBorrow_Qty", DbType.Int64, NoBorrow_Qty)
                End If
                db.ExecuteNonQuery(dbComm)
                SampleBorrow_UpdateNoBorrowQty = True
            Catch ex As Exception
                MsgBox(ex.Message)
                SampleBorrow_UpdateNoBorrowQty = False
            End Try
        End Function

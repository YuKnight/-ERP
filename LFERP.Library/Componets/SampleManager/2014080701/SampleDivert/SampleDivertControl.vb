Namespace LFERP.Library.SampleManager.SampleDivert
    Public Class SampleDivertControl

        Public Function SampleDivert_Add(ByVal objinfo As SampleDivertInfo) As Boolean
            Try
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("SampleDivert_Add")
                ...
                SampleDivert_Add = True
            Catch ex As Exception
                MsgBox(ex.Message)
                SampleDivert_Add = False
            End Try
        End Function

        Public Function SampleDivert_Update(ByVal objinfo As SampleDivertInfo) As Boolean
            Try
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("SampleDivert_Update")
                ...
                db.ExecuteNonQuery(dbComm)
                SampleDivert_Update = True
            Catch ex As Exception
                MsgBox(ex.Message)
                SampleDivert_Update = False
            End Try
        End Function

        Public Function SampleDivert_Check(ByVal objinfo As SampleDivertInfo) As Boolean
            Try
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("SampleDivert_Check")
                ...
                db.ExecuteNonQuery(dbComm)
                SampleDivert_Check = True
            Catch ex As Exception
                MsgBox(ex.Message)
                SampleDivert_Check = False
            End Try
        End Function

        Public Function SampleDivert_Delete(ByVal AutoID As String, ByVal SD_ID As String) As Boolean
            Try
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("SampleDivert_Delete")
                db.AddInParameter(dbComm, "@AutoID", DbType.String, AutoID)
                db.AddInParameter(dbComm, "@SD_ID", DbType.String, SD_ID)
                db.ExecuteNonQuery(dbComm)
                SampleDivert_Delete = True
            Catch ex As Exception
                MsgBox(ex.Message)
                SampleDivert_Delete = False
            End Try
        End Function


        Public Function SampleDivert_GetID(ByVal SD_ID As String) As SampleDivertInfo
            Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
            Dim dbComm As DbCommand = db.GetStoredProcCommand("SampleDivert_GetID")
            db.AddInParameter(dbComm, "@SD_ID", DbType.String, SD_ID)
            Dim FeatureList As New SampleDivertInfo
        ...
        Public Function SampleDivert_Getlist(ByVal AutoID As String, ByVal SD_ID As String, ByVal Code_ID As String, ByVal SD_OutSO_ID As String, ByVal SD_OutD_ID As String, _
        ByVal SD_OutPS_NO As String, ByVal SD_InSO_ID As String, ByVal SD_InD_ID As String, ByVal SD_InPS_NO As String, ByVal SD_Check As String, ByVal StartDate As String, ByVal EndDate As String, ByVal SD_AddUserID As String) As List(Of SampleDivertInfo)

            Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
            Dim dbComm As DbCommand = db.GetStoredProcCommand("SampleDivert_Getlist")
            ...
            Dim FeatureList As New List(Of SampleDivertInfo)
            Using reader As IDataReader = db.ExecuteReader(dbComm)
                While reader.Read
                    FeatureList.Add(FillSampleDivert(reader))
                End While
                Return FeatureList
            End Using
        End Function

        Friend Function FillSampleDivert(ByVal reader As IDataReader) As SampleDivertInfo
            On Error Resume Next

            Dim objInfo As New SampleDivertInfo

Namespace LFERP.Library.SampleManager.SamplePace
    Public Class SamplePaceInfo
        ...
        Private _SE_OutAccount As Boolean
        Private _SE_InAccount As Boolean
        ...
        Public Sub New()
            ...
            _SE_OutAccount = Nothing
            _SE_InAccount = Nothing
        ...
        Public Property SE_BorrowTime() As Integer
            ...
            End Set
        End Property
        Public Property SE_OutAccount() As Boolean
            Get
                Return _SE_OutAccount
            End Get
            Set(ByVal value As Boolean)
                _SE_OutAccount = value
            End Set
        End Property
        Public Property SE_INAccount() As Boolean
            Get
                Return _SE_InAccount
            End Get
            Set(ByVal value As Boolean)
                _SE_InAccount = value
            End Set

...
Class ReadWriteCard
    ...
    Public Class readwriteDll
        ...
        <DllImport("ResetPassWords.dll", EntryPoint:="SetPW", SetLastError:=True, CharSet:=CharSet.Unicode, ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)> _
        Public Shared Sub SetPW()
        End Sub
    End Class
End Class

...
Namespace LFERP.Library.NmetalSampleManager.NmetalSampleSend
    Public Class NmetalSampleSendShipFilesControl
        Public Function NmetalSampleSendShipFiles_Add(ByVal objinfo As NmetalSampleSendShipFilesInfo) As Boolean
            Try
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("NmetalSampleSendShipFiles_Add")
                ...
                NmetalSampleSendShipFiles_Add = True
            Catch ex As Exception
                MsgBox(ex.Message)
                NmetalSampleSendShipFiles_Add = False
            End Try
        End Function

        Public Function NmetalSampleSendShipFiles_Update(ByVal objinfo As NmetalSampleSendShipFilesInfo) As Boolean
            Try
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("NmetalSampleSendShipFiles_Update")
                ...
                db.ExecuteNonQuery(dbComm)
                NmetalSampleSendShipFiles_Update = True
            Catch ex As Exception
                MsgBox(ex.Message)
                NmetalSampleSendShipFiles_Update = False
            End Try
        End Function

        Public Function NmetalSampleSendShipFiles_Delete(ByVal AutoID As String) As Boolean
            Try
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("NmetalSampleSendShipFiles_Delete")
                db.AddInParameter(dbComm, "@AutoID", DbType.String, AutoID)

                db.ExecuteNonQuery(dbComm)
                NmetalSampleSendShipFiles_Delete = True

            Catch ex As Exception
                MsgBox(ex.Message)
                NmetalSampleSendShipFiles_Delete = False
            End Try
        End Function

        Public Function NmetalSampleSendShipFiles_GetList(ByVal SP_ID As String, ByVal AutoID As String, ByVal PM_M_Code As String) As List(Of NmetalSampleSendShipFilesInfo)
            Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
            Dim dbComm As DbCommand = db.GetStoredProcCommand("NmetalSampleSendShipFiles_GetList")

            db.AddInParameter(dbComm, "@SP_ID", DbType.String, SP_ID)
            db.AddInParameter(dbComm, "@AutoID", DbType.String, AutoID)
            db.AddInParameter(dbComm, "@PM_M_Code", DbType.String, PM_M_Code)
            Dim FeatureList As New List(Of NmetalSampleSendShipFilesInfo)
            Using reader As IDataReader = db.ExecuteReader(dbComm)
                While reader.Read
                    FeatureList.Add(FillNmetalSampleSendShipFiles(reader))
                End While
                Return FeatureList
            End Using
        End Function

        Public Function NmetalSampleSendShipFiles_DTGetList(ByVal SP_ID As String, ByVal AutoID As String, ByVal PM_M_Code As String) As DataTable
            Try
        ...
        Public Function FillNmetalSampleSendShipFiles(ByVal reader As IDataReader) As NmetalSampleSendShipFilesInfo
            On Error Resume Next
            Dim ObjectID As New NmetalSampleSendShipFilesInfo

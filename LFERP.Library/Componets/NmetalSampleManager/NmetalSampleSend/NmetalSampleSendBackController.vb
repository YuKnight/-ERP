...
Namespace LFERP.Library.NmetalSampleManager.NmetalSampleSend
    Public Class NmetalSampleSendBackControler
        Friend Function FillNmetalSampleSendBack(ByVal reader As IDataReader) As NmetalSampleSendBackInfo
            Dim objInfo As New NmetalSampleSendBackInfo
            ...
            '2014-08-07     Mark
            objInfo.SB_TWeight = reader("SB_TWeight")

            Return objInfo
        End Function

        Public Function NmetalSampleSendBack_GetList(ByVal SO_ID As String, ByVal SB_ID As String) As List(Of NmetalSampleSendBackInfo)
            Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
            Dim dbComm As DbCommand = db.GetStoredProcCommand("NmetalSampleSendBack_GetList")
            db.AddInParameter(dbComm, "@SO_ID", DbType.String, SO_ID)
            db.AddInParameter(dbComm, "@SB_ID", DbType.String, SB_ID)

            Dim FeatureList As New List(Of NmetalSampleSendBackInfo)
            Using reader As IDataReader = db.ExecuteReader(dbComm)
                While reader.Read
                    FeatureList.Add(FillNmetalSampleSendBack(reader))
                End While
                Return FeatureList
            End Using
        End Function

        Public Function NmetalSampleSendBack_Delete(ByVal SB_ID As String) As Boolean
            Try
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("NmetalSampleSendBack_Delete")
                db.AddInParameter(dbComm, "@SB_ID", DbType.String, SB_ID)

                db.ExecuteNonQuery(dbComm)
                NmetalSampleSendBack_Delete = True
            Catch ex As Exception
                MsgBox(ex.Message)
                NmetalSampleSendBack_Delete = False
            End Try
        End Function

        Public Function NmetalSampleSendBack_GetID(ByVal SB_ID As String) As NmetalSampleSendBackInfo
            Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
            Dim dbComm As DbCommand = db.GetStoredProcCommand("NmetalSampleSendBack_GetID")
            db.AddInParameter(dbComm, "@SB_ID", DbType.String, SB_ID)
            Dim FeatureList As New NmetalSampleSendBackInfo
            Using reader As IDataReader = db.ExecuteReader(dbComm)
                While reader.Read
        ...
        Public Function NmetalSampleSendBack_Update(ByVal objinfo As NmetalSampleSendBackInfo) As Boolean
            Try
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("NmetalSampleSendBack_Update")
                ...
                db.ExecuteNonQuery(dbComm)
                NmetalSampleSendBack_Update = True
            Catch ex As Exception
                MsgBox(ex.Message)
                NmetalSampleSendBack_Update = False
            End Try
        End Function


        Public Function NmetalSampleSendBack_Add(ByVal objInfo As NmetalSampleSendBackInfo) As Boolean
            Try
                Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
                Dim dbComm As DbCommand = db.GetStoredProcCommand("NmetalSampleSendBack_Add")
                db.AddInParameter(dbComm, "@SB_ID", DbType.String, objInfo.SB_ID)
                db.AddInParameter(dbComm, "@SO_ID", DbType.String, objInfo.SO_ID)
                db.AddInParameter(dbComm, "@SS_Edition", DbType.String, objInfo.SS_Edition)
                db.AddInParameter(dbComm, "@SB_Qty", DbType.Int64, objInfo.SB_Qty)
                ...
                '2014-08-07     Mark
                db.AddInParameter(dbComm, "@SB_TWeight", DbType.Decimal, objInfo.SB_TWeight)

                db.ExecuteNonQuery(dbComm)
                NmetalSampleSendBack_Add = True
            Catch ex As Exception
                MsgBox(ex.Message)
                NmetalSampleSendBack_Add = False
            End Try
        End Function
    End Class
End Namespace

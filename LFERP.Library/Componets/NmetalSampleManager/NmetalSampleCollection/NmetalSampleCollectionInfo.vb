Namespace LFERP.Library.NmetalSampleManager.NmetalSampleCollection
    Public Class NmetalSampleCollectionInfo
        ...
        Public Property RWeight() As Decimal
            Get
                Return _RWeight
            End Get
            Set(ByVal value As Decimal)
        ...
        Public Property TWeights() As Decimal
            Get
                Return _TWeights
            End Get
            Set(ByVal value As Decimal)

...
#End Region
        ...
        '查詢采購單
        Public Function MrpPurchaseOrder_Select_GetList(ByVal MrpModule As String, ByVal strWhere As String) As List(Of MrpPurchaseOrderInfo)
            Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
            Dim dbComm As DbCommand = db.GetStoredProcCommand("MrpSelect_GetList")
            db.AddInParameter(dbComm, "@MrpModule", DbType.String, MrpModule)
            db.AddInParameter(dbComm, "@strWhere", DbType.String, strWhere)
        ...
        '查詢生產計劃
        Public Function MrpMps_Select_GetList(ByVal MrpModule As String, ByVal strWhere As String) As List(Of MrpMpsInfo)
            Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
            Dim dbComm As DbCommand = db.GetStoredProcCommand("MrpSelect_GetList")
            db.AddInParameter(dbComm, "@MrpModule", DbType.String, MrpModule)
            db.AddInParameter(dbComm, "@strWhere", DbType.String, strWhere)
        ...
        '查詢請購申請
        Public Function MrpPurchaseRecord_Select_GetList(ByVal MrpModule As String, ByVal strWhere As String) As List(Of MrpPurchaseRecordInfo)
            Dim db As New Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase(ConnStr)
            Dim dbComm As DbCommand = db.GetStoredProcCommand("MrpSelect_GetList")
            db.AddInParameter(dbComm, "@MrpModule", DbType.String, MrpModule)
            db.AddInParameter(dbComm, "@strWhere", DbType.String, strWhere)

...
#End Region
    ...
    Private Sub Lodata()
        If EditItem = "Repay" Then
            ...
            gueID.Properties.DataSource = src.SampleRepay_GetList(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, False)
        ...
        Else
            ...
            gueID.Properties.DataSource = sbc.SampleBorrow_GetList(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, False)

...
Public Class frmQuotationWLMain

    Private Sub frmQuotationWLMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '************
        Grid1.DataSource = mc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, "物料", DateAdd(DateInterval.Month, -3, CDate(Format(Now, "yyyy/MM/dd"))), ">", Nothing, Nothing, False, tesuvalue)
        LoadUserPower()
        Me.Text = Label1.Text
    End Sub
    Sub LoadUserPower()
        ...
        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010401")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationNew.Enabled = True
        End If


        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010402")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationEdit.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010403")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationDel.Enabled = True
        End If


        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010404")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationCheck.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010405")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationAccCheck.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010406")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationSend.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010407")
        If pmwiL.Count > 0 Then
        ...
        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010409")
        If pmwiL.Count > 0 Then
    ...
    Private Sub popQuotationEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles popQuotationEdit.Click
        ...
        '修改于2010/10/29 主要針對于當前報價單存在部份物料已審核，另一部份還未被審核情況！
        ...
        'If (IsDBNull(qi(i).Q_AccCheck) = True And IsDBNull(qi(i).Q_Check) = True) Or (qi(i).Q_AccCheck = False And qi(i).Q_Check = False) Then
        If Check = True Then
            MsgBox("此單已存在有審核記錄，不允許修改!")
            Exit Sub
        Else
            Edit = True
            Dim fr As frmQuotation
    ...
    Private Sub popQuotationDel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles popQuotationDel.Click
        ...
        If (IsDBNull(qi.Q_AccCheck) = True And IsDBNull(qi.Q_Check) = True) Or (qi.Q_AccCheck = False And qi.Q_Check = False) Then
            If MsgBox("確定要刪除編號為" & GridView2.GetFocusedRowCellValue("Q_QuoID").ToString & "的所有報價單嗎？", MsgBoxStyle.YesNo, "刪除提示") = MsgBoxResult.Yes Then
                ...
                Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, "物料", DateAdd(DateInterval.Month, -3, CDate(Format(Now, "yyyy/MM/dd"))), ">", Nothing, Nothing, False, tesuvalue)
            End If
        Else
            MsgBox("此單已被審核，不允許刪除")
            Exit Sub
    ...
    Private Sub popQuotationSeek_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles popQuotationSeek.Click
        ...
        Select Case tempValue
            Case "1" '報價單號
                Grid1.DataSource = qc.Quotation_Getlist(tempValue2, Nothing, Nothing, Nothing, "物料", Nothing, Nothing, Nothing, Nothing, Nothing, tesuvalue)
            Case "2"  '物料規格 --暫無
                Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, tempValue2, "物料", Nothing, Nothing, Nothing, Nothing, Nothing, tesuvalue)
            Case "3" '物料名稱
                Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, tempValue2, Nothing, "物料", Nothing, Nothing, Nothing, Nothing, Nothing, tesuvalue)

            Case "4" '物料類型--暫無
                'If tempValue2 = "已審核" Then
                '    Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, "物料", Nothing, Nothing, Nothing, True, Nothing, tesuvalue)
                'ElseIf tempValue2 = "未審核" Then
                '    Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, "物料", Nothing, Nothing, Nothing, False, Nothing, tesuvalue)
                'End If
                Grid1.DataSource = qc.Quotation_Getlist(Nothing, tempValue2, Nothing, Nothing, "物料", Nothing, Nothing, Nothing, Nothing, Nothing, tesuvalue)
            Case "5"  '供應商
                'If tempValue2 = "已審核" Then
                '    Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, "物料", Nothing, Nothing, Nothing, Nothing, True, tesuvalue)
                'ElseIf tempValue2 = "未審核" Then
                '    Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, "物料", Nothing, Nothing, Nothing, Nothing, False, tesuvalue)
                'End If
                Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, "物料", Nothing, Nothing, tempValue2, Nothing, Nothing, tesuvalue)
            Case "6"
                'Grid1.DataSource = qc.Quotation_Getlist(Nothing, tempValue2, Nothing, "物料", Nothing, Nothing, Nothing, Nothing, Nothing, tesuvalue)

                Grid1.DataSource = pc.Quotation_Getlist(Label1.Text, tempValue2)
                'Case "7"
                '    Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, tempValue2, "物料", Nothing, Nothing, Nothing, Nothing, Nothing, tesuvalue)
    ...
    Private Sub popQuotationFile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles popQuotationFile.Click
        ...
        Else
            ...
            'End If
            FileShow("4001", GridView2.GetFocusedRowCellValue("Q_QuoID").ToString, True, True, False, False, False, False)

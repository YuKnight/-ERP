...
Public Class frmQuotationMain
    ...
    Sub LoadUserPower()
        ...
        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "400101")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationNew.Enabled = True
        End If


        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "400102")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationEdit.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "400103")
        If pmwiL.Count > 0 Then
        ...
        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "400106")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationSend.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "400107")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationCopy.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "400108")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationPrint.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "400109")
        If pmwiL.Count > 0 Then
    ...
    Private Sub frmQuotationMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '************
        Grid1.DataSource = mc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, DateAdd(DateInterval.Month, -3, CDate(Format(Now, "yyyy/MM/dd"))), ">", Nothing, False, False, tesuvalue)
        LoadUserPower()
    End Sub

    'Private Sub popQuotationPrint2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    'On Error Resume Next
    ...
    '    ds.Tables.Clear()
    '    ltc.CollToDataSet(ds, "Company", mcCompany.Company_Getlist(GridView2.GetFocusedRowCellValue("CO_ID").ToString, Nothing, Nothing))
    '    ltc1.CollToDataSet(ds, "Suppliers", mcSupplier.GetSuppliersList(GridView2.GetFocusedRowCellValue("Q_Supplier").ToString, Nothing, Nothing, Nothing))
    '    ltc2.CollToDataSet(ds, "Quotation", mcQuotation.Quotation_Getlist(GridView2.GetFocusedRowCellValue("Q_QuoID").ToString, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing))
    ...
    '    PreviewRPT(ds, "rptQuotation", " 詢價單--" & GridView2.GetFocusedRowCellValue("Q_QuoID").ToString, True, True)
    '    ltc = Nothing
    '    ltc1 = Nothing
    '    ltc2 = Nothing
    '    ltc3 = Nothing
    ...
    Private Sub popQuotationDel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles popQuotationDel.Click
        ...
        If (IsDBNull(qi.Q_AccCheck) = True And IsDBNull(qi.Q_Check) = True) Or (qi.Q_AccCheck = False And qi.Q_Check = False) Then
            If MsgBox("確定要刪除編號為" & GridView2.GetFocusedRowCellValue("Q_QuoID").ToString & "的所有報價單嗎？", MsgBoxStyle.YesNo, "刪除提示") = MsgBoxResult.Yes Then
                ...
                Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, DateAdd(DateInterval.Month, -3, CDate(Format(Now, "yyyy/MM/dd"))), ">", Nothing, Nothing, Nothing, tesuvalue)
            End If
        Else
            MsgBox("此單已被審核，不允許刪除")
            Exit Sub
    ...
    Private Sub popQuotationSeek_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles popQuotationSeek.Click
        ...
        Select Case tempValue
            Case "1"
                Grid1.DataSource = qc.Quotation_Getlist(tempValue2, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, tesuvalue)
            Case "2"
                Grid1.DataSource = qc.Quotation_Getlist(Nothing, tempValue2, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, tesuvalue)
            Case "3"
                Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, tempValue2, Nothing, Nothing, tesuvalue)

            Case "4"
                If tempValue2 = "已審核" Then
                    Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, True, Nothing, tesuvalue)
                ElseIf tempValue2 = "未審核" Then
                    Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, False, Nothing, tesuvalue)
                End If
            Case "5"
                If tempValue2 = "已審核" Then
                    Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, True, tesuvalue)
                ElseIf tempValue2 = "未審核" Then
                    Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, False, tesuvalue)
                End If
            Case "6"
                Grid1.DataSource = qc.Quotation_Getlist(Nothing, tempValue2, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, tesuvalue)

            Case "7"
                Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, tempValue2, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, tesuvalue)

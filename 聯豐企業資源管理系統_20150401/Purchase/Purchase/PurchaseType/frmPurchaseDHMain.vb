...
Public Class frmPurchaseDHMain

    Private Sub frmPurchaseDHMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        pmwil1 = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020117")
        ...
        Select Case strTemp
            ...
            Case "采購員"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "大貨批次", Nothing, Nothing, Nothing, InUserID, "采購作業", Nothing, Nothing, False, tesuvalue)
            Case "采購主管"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "大貨批次", Nothing, Nothing, Nothing, Nothing, "采購作業", False, Nothing, Nothing, tesuvalue)
            Case "會計部"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "大貨批次", Nothing, Nothing, Nothing, Nothing, "采購作業", True, False, Nothing, tesuvalue)
            Case "管理員"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "大貨批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, Nothing, Nothing, tesuvalue)
        End Select

        LoadUserPower()
        Label1.Text = "采購管理--大貨採購"
    ...
    Sub LoadUserPower()
        ...
        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020101")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popPurchaseNew.Enabled = True
        End If


        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020102")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popPurchaseEdit.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020103")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popPurchaseDel.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020104")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popPurchaseCheck.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020105")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popPurchaseAccCheck.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020106")
        If pmwiL.Count > 0 Then
        ...
        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020108")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popPurchasePrintEng.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020109")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then PurchaseRead.Enabled = True
        End If
        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020116")
        If pmwiL.Count > 0 Then
        ...
        If (IsDBNull(pi.PM_AccountCheck) = True And IsDBNull(pi.PM_Check) = True) Or (pi.PM_AccountCheck = False And pi.PM_Check = False) Then
            If MsgBox("確定要刪除編號為" & GridView2.GetFocusedRowCellValue("PM_NO").ToString & "的所有採購單嗎？", MsgBoxStyle.YesNo, "刪除提示") = MsgBoxResult.Yes Then
                ...
                If pc.PurchaseMain_Delete(GridView2.GetFocusedRowCellValue("PM_NO").ToString) = True Then
                    ...
                    End If
                End If
                Grid1.DataSource = pc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "大貨批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, Nothing, False, tesuvalue)
            End If
        Else
            MsgBox("此單已被審核，不允許刪除")
            Exit Sub
    ...
    Private Sub popPurchaseSeek_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles popPurchaseSeek.Click
        ...
        Select Case tempValue
            ...
            Case "1"
                Grid1.DataSource = mc.PurchaseMain_Getlist(tempValue2, Nothing, Nothing, Nothing, Nothing, Nothing, "大貨批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, Nothing, Nothing, tesuvalue)
            Case "2"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, tempValue2, Nothing, Nothing, "大貨批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, Nothing, Nothing, tesuvalue)
            Case "3"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "大貨批次", Nothing, Nothing, tempValue2, Nothing, "采購作業", Nothing, Nothing, Nothing, tesuvalue)

            Case "4"
                If tempValue2 = "已審核" Then
                    Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "大貨批次", Nothing, Nothing, Nothing, Nothing, "采購作業", True, Nothing, Nothing, tesuvalue)
                ElseIf tempValue2 = "未審核" Then
                    Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "大貨批次", Nothing, Nothing, Nothing, Nothing, "采購作業", False, Nothing, Nothing, tesuvalue)
                End If
            Case "5"
                If tempValue2 = "已審核" Then
                    Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "大貨批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, True, Nothing, tesuvalue)
                ElseIf tempValue2 = "未審核" Then
                    Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "大貨批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, False, Nothing, tesuvalue)
                End If

            Case "6"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, tempValue2, Nothing, Nothing, "大貨批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, Nothing, Nothing, tesuvalue)
            Case "7"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, tempValue2, Nothing, "大貨批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, Nothing, Nothing, tesuvalue)
            Case "8"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "大貨批次", Nothing, Nothing, Nothing, tempValue2, "采購作業", Nothing, Nothing, Nothing, tesuvalue)
            Case "9"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, tempValue2, "大貨批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, Nothing, Nothing, tesuvalue)

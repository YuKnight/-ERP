...
Public Class frmPurchasePJMain

    Private Sub frmPurchasePJMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        pmwil1 = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020317")
        ...
        Select Case strTemp
            ...
            Case "采購員"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, InUserID, "采購作業", Nothing, Nothing, False, tesuvalue)
            Case "采購主管"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, "采購作業", False, Nothing, Nothing, tesuvalue)
            Case "會計部"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, "采購作業", True, False, Nothing, tesuvalue)
            Case "管理員"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, Nothing, Nothing, tesuvalue)
        End Select

        LoadUserPower()
        Label1.Text = "采購管理--配件採購"
    ...
    Sub LoadUserPower()
        ...
        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020301")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popPurchaseNew.Enabled = True
        End If


        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020302")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popPurchaseEdit.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020303")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popPurchaseDel.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020304")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popPurchaseCheck.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020305")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popPurchaseAccCheck.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020306")
        If pmwiL.Count > 0 Then
        ...
        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020308")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popPurchasePrintEng.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020309")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then PurchaseRead.Enabled = True
        End If
        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40020316")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popSupplierReturn.Enabled = True
        End If
    End Sub
        ...
        If (IsDBNull(pi.PM_AccountCheck) = True And IsDBNull(pi.PM_Check) = True) Or (pi.PM_AccountCheck = False And pi.PM_Check = False) Then
            If MsgBox("確定要刪除編號為" & GridView2.GetFocusedRowCellValue("PM_NO").ToString & "的所有採購單嗎？", MsgBoxStyle.YesNo, "刪除提示") = MsgBoxResult.Yes Then
                ...
                If pc.PurchaseMain_Delete(GridView2.GetFocusedRowCellValue("PM_NO").ToString) = True Then
                    ...
                    End If
                End If
                Grid1.DataSource = pc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, Nothing, False, tesuvalue)
            End If
        Else
            MsgBox("此單已被審核，不允許刪除")
            Exit Sub
    ...
    Private Sub popPurchaseSeek_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles popPurchaseSeek.Click
        ...
        'Grid1.DataSource = mc.PurchaseMain_Getlist(tempValue2, Nothing, Nothing, tempValue6, tempValue7, "配件批次", Nothing, Nothing, tempValue4, tempValue8, "采購作業", tempValue5, tempValue9, Nothing, tesuvalue)
        Select Case tempValue

            Case "1"
                Grid1.DataSource = mc.PurchaseMain_Getlist(tempValue2, Nothing, Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, Nothing, Nothing, tesuvalue)
            Case "2"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, tempValue2, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, Nothing, Nothing, tesuvalue)
            Case "3"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, tempValue2, Nothing, "采購作業", Nothing, Nothing, Nothing, tesuvalue)

            Case "4"
                If tempValue2 = "已審核" Then
                    Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, "采購作業", True, Nothing, Nothing, tesuvalue)
                ElseIf tempValue2 = "未審核" Then
                    Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, "采購作業", False, Nothing, Nothing, tesuvalue)
                End If
            Case "5"
                If tempValue2 = "已審核" Then
                    Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, True, Nothing, tesuvalue)
                ElseIf tempValue2 = "未審核" Then
                    Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, False, Nothing, tesuvalue)
                End If

            Case "6"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, tempValue2, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, Nothing, Nothing, tesuvalue)
            Case "7"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, tempValue2, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, Nothing, Nothing, tesuvalue)
            Case "8"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, tempValue2, "采購作業", Nothing, Nothing, Nothing, tesuvalue)
            Case "9"
                Grid1.DataSource = mc.PurchaseMain_Getlist(Nothing, Nothing, Nothing, Nothing, Nothing, tempValue2, "配件批次", Nothing, Nothing, Nothing, Nothing, "采購作業", Nothing, Nothing, Nothing, tesuvalue)
    ...
    Private Sub Grid1_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Grid1.MouseUp
        ...
        Dim psc As New Purchase.PurchaseSubsControl
        GridControl4.DataSource = psc.PurchaseSubs_GetList(strA, strB, Nothing)
    End Sub
    ...
    '主要針對大貨和配件批次的交貨日期而言！
    Private Sub popSupplierReturn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles popSupplierReturn.Click
        tempValue = GridView2.GetFocusedRowCellValue("PM_NO").ToString()
        tempValue2 = GridView2.GetFocusedRowCellValue("M_Code").ToString()
        Dim frm As New frmSupplierReturn
        frm.ShowDialog()
    End Sub

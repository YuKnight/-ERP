...
Public Class frmReWorkMain

    Dim oi As New OutwardInfo
    Dim oc As New OutwardController

    Private Sub frmReWorkMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Grid1.DataSource = oc.OutwardMain_GetList(Nothing, "返修作業", Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing)
        LoadUserPower() '此權限公用外發加工
    End Sub
    ...
    Private Sub cmdQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdQuery.Click
        ...
        Select Case tempValue
            ...
            Case "1"
                Grid1.DataSource = oc.OutwardMain_GetList(tempValue2, "返修作業", Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing)
            Case "2"
                Grid1.DataSource = oc.OutwardMain_GetList(Nothing, "返修作業", Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing)
            Case "3"
                Grid1.DataSource = oc.OutwardMain_GetList(Nothing, "返修作業", Nothing, Nothing, Nothing, tempValue2, tempValue3, Nothing, Nothing, Nothing, Nothing, Nothing)
            Case "4"
                Grid1.DataSource = oc.OutwardMain_GetList(Nothing, "返修作業", Nothing, Nothing, Nothing, Nothing, Nothing, tempValue2, Nothing, Nothing, Nothing, Nothing)
            Case "5"
                Grid1.DataSource = oc.OutwardMain_GetList(Nothing, "返修作業", Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, tempValue2, Nothing, Nothing, Nothing)
            Case "6"
                Grid1.DataSource = oc.OutwardMain_GetList(Nothing, "返修作業", Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, tempValue2, Nothing, Nothing)
        End Select
        tempValue = ""
        tempValue2 = ""
        tempValue3 = ""

Public Class frmProductionKaiLiaoReturnSeek
    ...
    Private Sub frmProductionKaiLiaoReturnSeek_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        txtR_NO.Select()
    End Sub

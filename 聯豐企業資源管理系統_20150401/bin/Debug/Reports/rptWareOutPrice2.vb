...
Public Class rptWareOutPrice2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptWareOutPrice2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWareOutPrice2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWareOutPrice2 = New rptWareOutPrice2
        rpt.Site = Me.Site
        Return rpt
    End Function

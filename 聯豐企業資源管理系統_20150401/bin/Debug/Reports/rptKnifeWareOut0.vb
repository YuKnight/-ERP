...
Public Class rptKnifeWareOut0
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptKnifeWareOut0.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptKnifeWareOut0
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptKnifeWareOut0 = New rptKnifeWareOut0
        rpt.Site = Me.Site
        Return rpt
    End Function

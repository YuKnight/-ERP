...
Public Class rptSamPackingAll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptSamPackingAll.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Worker() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptSamPackingAll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSamPackingAll = New rptSamPackingAll
        rpt.Site = Me.Site
        Return rpt
    End Function

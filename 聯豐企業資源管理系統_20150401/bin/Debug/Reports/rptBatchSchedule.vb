...
Public Class rptBatchSchedule
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptBatchSchedule.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBatchSchedule
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBatchSchedule = New rptBatchSchedule
        rpt.Site = Me.Site
        Return rpt
    End Function

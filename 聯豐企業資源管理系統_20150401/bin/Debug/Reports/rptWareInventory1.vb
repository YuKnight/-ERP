...
Public Class rptWareInventory1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptWareInventory1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PrintUser() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NoUse() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptWareInventory1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWareInventory1 = New rptWareInventory1
        rpt.Site = Me.Site
        Return rpt
    End Function

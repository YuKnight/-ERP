...
Public Class rptWareInventory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptWareInventory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWareInventory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWareInventory = New rptWareInventory
        rpt.Site = Me.Site
        Return rpt
    End Function

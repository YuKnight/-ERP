...
Public Class rptRetrocedeNotAll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptRetrocedeNotAll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRetrocedeNotAll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRetrocedeNotAll = New rptRetrocedeNotAll
        rpt.Site = Me.Site
        Return rpt
    End Function

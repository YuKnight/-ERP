...
Public Class rptProductionWareShipped
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptProductionWareShipped.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptProductionWareShipped.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Para1() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Para2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptProductionWareShipped
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductionWareShipped = New rptProductionWareShipped
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rptProductionOutProcess1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptProductionOutProcess1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptProductionOutProcess1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProductionOutProcess1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductionOutProcess1 = New rptProductionOutProcess1
        rpt.Site = Me.Site
        Return rpt
    End Function

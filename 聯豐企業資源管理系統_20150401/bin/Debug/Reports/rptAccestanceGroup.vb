...
Public Class rptAccestanceGroup
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptAccestanceGroup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAccestanceGroup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAccestanceGroup = New rptAccestanceGroup
        rpt.Site = Me.Site
        Return rpt
    End Function

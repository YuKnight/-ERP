...
Public Class rptKnifeWareInput1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptKnifeWareInput1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptKnifeWareInput1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptKnifeWareInput1 = New rptKnifeWareInput1
        rpt.Site = Me.Site
        Return rpt
    End Function

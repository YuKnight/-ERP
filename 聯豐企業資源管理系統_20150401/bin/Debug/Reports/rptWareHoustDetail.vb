...
Public Class rptWareHoustDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptWareHoustDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWareHoustDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWareHoustDetail = New rptWareHoustDetail
        rpt.Site = Me.Site
        Return rpt
    End Function

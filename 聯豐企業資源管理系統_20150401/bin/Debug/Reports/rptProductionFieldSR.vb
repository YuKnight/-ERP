...
Public Class rptProductionFieldSR
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptProductionFieldSR.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptProductionFieldSR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProductionFieldSR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductionFieldSR = New rptProductionFieldSR
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rptOrdersBomQC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptOrdersBomQC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOrdersBomQC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOrdersBomQC = New rptOrdersBomQC
        rpt.Site = Me.Site
        Return rpt
    End Function

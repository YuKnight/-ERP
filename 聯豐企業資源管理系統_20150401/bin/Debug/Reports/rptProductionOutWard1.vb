...
Public Class rptProductionOutWard1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptProductionOutWard1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptProductionOutWard1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProductionOutWard1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductionOutWard1 = New rptProductionOutWard1
        rpt.Site = Me.Site
        Return rpt
    End Function

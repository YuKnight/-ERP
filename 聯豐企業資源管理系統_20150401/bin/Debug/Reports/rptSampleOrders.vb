...
Public Class rptSampleOrders
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptSampleOrders.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSampleOrders
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSampleOrders = New rptSampleOrders
        rpt.Site = Me.Site
        Return rpt
    End Function

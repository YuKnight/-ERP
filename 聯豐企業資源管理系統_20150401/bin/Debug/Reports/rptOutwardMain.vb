...
Public Class rptOutwardMain
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptOutwardMain.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOutwardMain
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOutwardMain = New rptOutwardMain
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rptWhiteuserList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptWhiteuserList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWhiteuserList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWhiteuserList = New rptWhiteuserList
        rpt.Site = Me.Site
        Return rpt
    End Function

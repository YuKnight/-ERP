...
Public Class rptWareOutPrice3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptWareOutPrice3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWareOutPrice3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWareOutPrice3 = New rptWareOutPrice3
        rpt.Site = Me.Site
        Return rpt
    End Function

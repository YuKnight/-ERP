...
Public Class rptPurchasePrice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptPurchasePrice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchasePrice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchasePrice = New rptPurchasePrice
        rpt.Site = Me.Site
        Return rpt
    End Function

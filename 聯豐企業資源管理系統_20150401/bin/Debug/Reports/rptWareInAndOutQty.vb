...
Public Class rptWareInAndOutQty
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptWareInAndOutQty.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWareInAndOutQty
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWareInAndOutQty = New rptWareInAndOutQty
        rpt.Site = Me.Site
        Return rpt
    End Function

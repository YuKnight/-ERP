...
Public Class rptPurchaseEng
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptPurchaseEng.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchaseEng
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchaseEng = New rptPurchaseEng
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rptWareOutNoCard1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptWareOutNoCard1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWareOutNoCard1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWareOutNoCard1 = New rptWareOutNoCard1
        rpt.Site = Me.Site
        Return rpt
    End Function

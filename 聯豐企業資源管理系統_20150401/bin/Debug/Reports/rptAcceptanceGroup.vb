...
Public Class rptAcceptanceGroup
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptAcceptanceGroup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAcceptanceGroup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAcceptanceGroup = New rptAcceptanceGroup
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rptWareOutPrice4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptWareOutPrice4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWareOutPrice4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWareOutPrice4 = New rptWareOutPrice4
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rptProductionApply
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptProductionApply.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProductionApply
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductionApply = New rptProductionApply
        rpt.Site = Me.Site
        Return rpt
    End Function

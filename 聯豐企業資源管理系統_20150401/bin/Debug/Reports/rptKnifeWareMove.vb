...
Public Class rptKnifeWareMove
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptKnifeWareMove.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptKnifeWareMove
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptKnifeWareMove = New rptKnifeWareMove
        rpt.Site = Me.Site
        Return rpt
    End Function

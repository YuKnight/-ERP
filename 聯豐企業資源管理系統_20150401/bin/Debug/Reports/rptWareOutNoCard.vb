...
Public Class rptWareOutNoCard
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptWareOutNoCard.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWareOutNoCard
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWareOutNoCard = New rptWareOutNoCard
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rptPurchaseMainGroup
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPurchaseMainGroup.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptPurchaseMainGroup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchaseMainGroup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchaseMainGroup = New rptPurchaseMainGroup
        rpt.Site = Me.Site
        Return rpt
    End Function

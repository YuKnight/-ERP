...
Public Class rptSingleFactory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptSingleFactory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSingleFactory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSingleFactory = New rptSingleFactory
        rpt.Site = Me.Site
        Return rpt
    End Function

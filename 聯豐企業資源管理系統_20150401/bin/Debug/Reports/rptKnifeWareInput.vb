...
Public Class rptKnifeWareInput
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptKnifeWareInput.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptKnifeWareInput
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptKnifeWareInput = New rptKnifeWareInput
        rpt.Site = Me.Site
        Return rpt
    End Function

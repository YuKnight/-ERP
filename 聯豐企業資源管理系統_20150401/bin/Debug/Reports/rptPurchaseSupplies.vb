...
Public Class rptPurchaseSupplies
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPurchaseSupplies.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptPurchaseSupplies.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchaseSupplies
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchaseSupplies = New rptPurchaseSupplies
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rptQuotationGroup
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptQuotationGroup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptQuotationGroup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptQuotationGroup = New rptQuotationGroup
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rptPurchasePmActor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptPurchasePmActor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchasePmActor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchasePmActor = New rptPurchasePmActor
        rpt.Site = Me.Site
        Return rpt
    End Function

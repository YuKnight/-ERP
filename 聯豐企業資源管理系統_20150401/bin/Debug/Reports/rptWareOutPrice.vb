...
Public Class rptWareOutPrice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptWareOutPrice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWareOutPrice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWareOutPrice = New rptWareOutPrice
        rpt.Site = Me.Site
        Return rpt
    End Function

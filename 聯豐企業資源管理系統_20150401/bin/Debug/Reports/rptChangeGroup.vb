...
Public Class rptChangeGroup
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptChangeGroup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptChangeGroup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptChangeGroup = New rptChangeGroup
        rpt.Site = Me.Site
        Return rpt
    End Function

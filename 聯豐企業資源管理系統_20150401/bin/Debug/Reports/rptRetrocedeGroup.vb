...
Public Class rptRetrocedeGroup
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptRetrocedeGroup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRetrocedeGroup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRetrocedeGroup = New rptRetrocedeGroup
        rpt.Site = Me.Site
        Return rpt
    End Function

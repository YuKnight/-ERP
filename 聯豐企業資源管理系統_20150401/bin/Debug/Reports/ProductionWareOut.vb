...
Public Class ProductionWareOut
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.ProductionWareOut.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProductionWareOut
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProductionWareOut = New ProductionWareOut
        rpt.Site = Me.Site
        Return rpt
    End Function

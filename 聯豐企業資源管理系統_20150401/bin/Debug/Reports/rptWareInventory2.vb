...
Public Class rptWareInventory2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptWareInventory2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWareInventory2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWareInventory2 = New rptWareInventory2
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rptProductionFieldSR1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptProductionFieldSR1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptProductionFieldSR1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProductionFieldSR1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductionFieldSR1 = New rptProductionFieldSR1
        rpt.Site = Me.Site
        Return rpt
    End Function

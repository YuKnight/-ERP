...
Public Class rptMaterialCode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptMaterialCode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMaterialCode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMaterialCode = New rptMaterialCode
        rpt.Site = Me.Site
        Return rpt
    End Function

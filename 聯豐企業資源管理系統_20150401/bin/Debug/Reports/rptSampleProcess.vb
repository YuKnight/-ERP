...
Public Class rptSampleProcess
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptSampleProcess.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSampleProcess
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSampleProcess = New rptSampleProcess
        rpt.Site = Me.Site
        Return rpt
    End Function

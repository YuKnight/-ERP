...
Public Class rptPurchaseChs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LFERP.rptPurchaseChs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchaseChs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchaseChs = New rptPurchaseChs
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Partial Class frmNmetalSampleEmailSetting
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmNmetalSampleEmailSetting))
        ...
        Me.StoreTime = New DevExpress.XtraGrid.Columns.GridColumn
        Me.CycleTime = New DevExpress.XtraGrid.Columns.GridColumn
        Me.StoreCycleTime = New DevExpress.XtraGrid.Columns.GridColumn
        ...
        Me.PictureBox1.Size = New System.Drawing.Size(980, 32)
        ...
        Me.Grid1.Name = "Grid1"
        Me.Grid1.Size = New System.Drawing.Size(980, 455)
        ...
        Me.cmdAdd.Size = New System.Drawing.Size(163, 22)
        Me.cmdAdd.Text = "新增(&A)"
        '
        'cmdDel
        '
        ...
        Me.cmdDel.Size = New System.Drawing.Size(163, 22)
        Me.cmdDel.Text = "刪除(&D)"
        '
        'cmdEdit
        '
        ...
        Me.cmdRef.Size = New System.Drawing.Size(163, 22)
        Me.cmdRef.Text = "刷新(&R)"
        '
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.AutoID, Me.Email_UserID, Me.Email_UserName, Me.CheckOrder, Me.Email, Me.Remark, Me.StateAlarmTime, Me.EndAlarmTime, Me.StoreTime, Me.CycleTime, Me.StoreCycleTime})
        ...
        Me.StateAlarmTime.VisibleIndex = 3
        ...
        Me.EndAlarmTime.VisibleIndex = 4
        Me.EndAlarmTime.Width = 97
        '
        'StoreTime
        '
        Me.StoreTime.AppearanceCell.Options.UseTextOptions = True
        Me.StoreTime.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far
        Me.StoreTime.Caption = "存放时间(小时)"
        Me.StoreTime.FieldName = "StoreTime"
        Me.StoreTime.Name = "StoreTime"
        Me.StoreTime.Visible = True
        Me.StoreTime.VisibleIndex = 5
        Me.StoreTime.Width = 109
        '
        'CycleTime
        '
        Me.CycleTime.AppearanceCell.Options.UseTextOptions = True
        Me.CycleTime.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far
        Me.CycleTime.Caption = "循环时间(分钟)"
        Me.CycleTime.FieldName = "CycleTime"
        Me.CycleTime.Name = "CycleTime"
        Me.CycleTime.Visible = True
        Me.CycleTime.VisibleIndex = 6
        Me.CycleTime.Width = 109
        '
        'StoreCycleTime
        '
        Me.StoreCycleTime.AppearanceCell.Options.UseTextOptions = True
        Me.StoreCycleTime.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far
        Me.StoreCycleTime.Caption = "循环存放时间(分钟)"
        Me.StoreCycleTime.FieldName = "StoreCycleTime"
        Me.StoreCycleTime.Name = "StoreCycleTime"
        Me.StoreCycleTime.Visible = True
        Me.StoreCycleTime.VisibleIndex = 7
        Me.StoreCycleTime.Width = 132
        '
        'frmNmetalSampleEmailSetting
        '
        ...
        Me.Name = "frmNmetalSampleEmailSetting"
        Me.Text = "邮箱报警设置"
    ...
    Friend WithEvents StoreTime As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents CycleTime As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents StoreCycleTime As DevExpress.XtraGrid.Columns.GridColumn
End Class

...
Public Class frmNmetalSampleBorrow
...
#Region "加載數據"
    Private Sub LoadData(ByVal PO As String)
        Dim objlist As New List(Of NmetalSampleBorrowInfo)
        objlist = sbc.NmetalSampleBorrow_GetList(BorrowID, Nothing, Nothing, Nothing, Nothing, Nothing, False)
...
#End Region
    ...
    Private Sub SaveData(ByVal editItem As String)
        Try
            Dim sbi As New NmetalSampleBorrowInfo
            ...
            If editItem = EditEnumType.ADD Then
                txt_BorrowID.EditValue = sbc.NmetalSampleBorrow_GetNewID()
                sbi.BorrowID = txt_BorrowID.EditValue
                sbi.CreateUserID = InUserID
                If sbc.NmetalSampleBorrow_Add(sbi) = True Then
            ...
            ElseIf editItem = EditEnumType.EDIT Then
                ...
                If sbc.NmetalSampleBorrow_Update(sbi) = True Then
...
#End Region
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Select Case EditItem
            ...
            Case EditEnumType.CHECK
                ...
                If sbc.NmetalSampleBorrow_UpdateCheck(sbi) = True Then
    ...
    Private Sub gluMaterialType_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If gluPM_M_Code.EditValue <> String.Empty Then
            Dim sblist As List(Of NmetalSampleBorrowInfo)
            sblist = sbc.NmetalSampleBorrowPM_M_Code_GetList(gluPM_M_Code.EditValue)
    ...
    Private Sub gluPS_NO_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles gluPS_NO.EditValueChanged
        If EditItem = EditEnumType.ADD Or EditItem = EditEnumType.EDIT Then
            Dim swlist As New List(Of NmetalSampleWareInventoryInfo)
            swlist = swcon.NmetalSampleWareInventoryA_Getlist(Me.gluD_ID.EditValue, gluPS_NO.EditValue, Me.gluPM_M_Code.EditValue, Nothing)

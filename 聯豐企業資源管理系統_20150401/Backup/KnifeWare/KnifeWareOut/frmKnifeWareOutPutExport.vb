Public Class frmKnifeWareOutPutExport
    ...
    Private Sub frmKnifeWareOutPutExport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        m_DTReport = ""
        m_BolReport = False

...
Public Class frmKnifeBOMSelect
    ...
    ''''''''''''2013-11-6 姚駿新增
    Private m_StrKnifeOut As String             '刀具出庫判別標識
    Public Property KnifeOut() As String
        Get
            Return m_StrKnifeOut
        End Get
        Set(ByVal value As String)
            m_StrKnifeOut = value
        End Set
    End Property
    Private m_StrKnifeInPut As String              '刀具出庫判別標識
    Public Property KnifeInPut() As String
        Get
            Return m_StrKnifeInPut
        End Get
        Set(ByVal value As String)
            m_StrKnifeInPut = value
        End Set
    End Property

    Private m_WI_SQty As String             '新刀數量
    Public Property BOWI_SQty() As String
        Get
            Return m_WI_SQty
        End Get
        Set(ByVal value As String)
    ...
    Private m_WI_SReQty As String            '待處理刀數量
    Public Property BOWI_SReQty() As String
        Get
            Return m_WI_SReQty
        End Get
        Set(ByVal value As String)
    ...
    Private Sub frmBOMSelect_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End If
        If Label5.Text = "生產倉庫調撥" Or (Label5.Text = "倉庫管理" And Label4.Text = "W1101") Then
    ...
    Private Sub Grid_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Grid.MouseUp
        ...
        m_WI_SQty = GridView4.GetFocusedRowCellValue("WI_SQty")
        m_WI_SReQty = GridView4.GetFocusedRowCellValue("WI_SReQty")
    ...
    Sub LoadMaterialCodeData()
        ...
        '************
        '''''''''''''''''''2013-11-7 姚駿新增
        'If m_StrKnifeOut = "刀具出庫單" Then
        '    mi = mc.MaterialCode_GetKnifeList(strCode, strName, strGauge, strTypeID, strSupplierNo, Stra)          
        'Else
        ...
        'End If
        If m_StrKnifeInPut = "刀具入庫單" Then
            mi = mc.MaterialCode_GetList(strCode, strName, strGauge, strTypeID, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, strSupplierNo, Stra)
        Else
            mi = mc.MaterialCode_GetKnifeList(strCode, strName, strGauge, strTypeID, strSupplierNo, Stra, Label4.Text)
        End If
        '''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Private Sub frmBOMSelect_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        m_StrKnifeInPut = ""
    End Sub

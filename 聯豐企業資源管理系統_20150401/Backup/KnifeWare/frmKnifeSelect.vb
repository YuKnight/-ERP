...
Public Class frmKnifeSelect
        ...
        If XtraTabControl1.SelectedTabPageIndex = 0 Then
            ...
            If RadioButton1.Checked = True Then
                If ComboBoxEdit1.Text = "入庫單號" Or ComboBoxEdit1.Text = "出庫單號" Or ComboBoxEdit1.Text = "調拔單號" Or ComboBoxEdit1.Text = "借刀單號" Or ComboBoxEdit1.Text = "還刀單號" Then
                    tempValue = 1
                ElseIf ComboBoxEdit1.Text = "刀具編碼" Then
                    tempValue = 2
                ElseIf ComboBoxEdit1.Text = "刀具名稱" Then
                    tempValue = 3

                ElseIf ComboBoxEdit1.Text = "借刀流水號" Or ComboBoxEdit1.Text = "還刀流水號" Then
                    tempValue = 4
                End If
                tempValue2 = TextEdit1.Text.Trim
            End If

            If RadioButton2.Checked = True Then '刀具類別
                tempValue = 5
    ...
    Private Sub LoadTable()
        ...
        If TempA = "刀具入庫" Then
            StrA = "入庫單號,刀具編碼,刀具名稱,刀具規格,刀具類別,入庫日期,部門審核,會計審核,單位,倉庫名稱,數量,備注"
        ...
        End If
        If TempA = "刀具出庫" Then
            StrA = "出庫單號,刀具編碼,刀具名稱,刀具規格,刀具類別,申領單號,出庫日期,申領部門,領料工號,領料人姓名,部門審核,會計審核,單位,倉庫名稱,數量,備注"
        ...
        End If
        If TempA = "刀具調撥" Then
            StrA = "調拔單號,刀具編碼,刀具名稱,刀具規格,刀具類別,調撥日期,部門審核,單位,收發性質,倉庫名稱,數量,備注"
            StrB = "文字,文字,文字,文字,文字,日期,文字,文字,文字,文字,數字,文字"
    ...
    Private Sub SimpleButton7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton7.Click
        ...
        If GridView1.GetFocusedRowCellValue("Category") = "刀具類別" Then
    ...
    Private Sub GridView1_FocusedRowChanged(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs) Handles GridView1.FocusedRowChanged
        ...
        ElseIf GridView1.GetFocusedRowCellValue("Type") = "數字" Then
            ...
            bteWHID.Enabled = False
        Else
            Dim tempC As String = "入庫單號,出庫單號,借刀流水號,借刀單號,借刀流水號,收發性質,借刀人,還刀單號,還刀流水號,還刀人,代還刀人,調拔單號,刀具名稱,刀具規格,刀具編碼,領料工號,申領單號,領料人姓名,單位,備注"
    ...
    Private Sub Tv1_AfterSelect(ByVal sender As System.Object, ByVal e As System.Windows.Forms.TreeViewEventArgs) Handles Tv1.AfterSelect
        ...
        'If TempA = "刀具庫存" Or TempA = "刀具借刀" Or TempA = "刀具還刀" Then
    ...
    Private Sub SimpleButton5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton5.Click
        ...
        Dim Row As DataRow
        Row = ds.Tables("SelectTbDel").NewRow
        If GridView1.GetFocusedRowCellValue("Category") = "刀具名稱" Or GridView1.GetFocusedRowCellValue("Category") = "刀具規格" Or GridView1.GetFocusedRowCellValue("Category") = "刀具類別" Or GridView1.GetFocusedRowCellValue("Category") = "備注" Or GridView1.GetFocusedRowCellValue("Category") = "刀具編碼" Then

...
Public Class frmQuotationPJMain

    Private Sub frmQuotationPJMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '************
        Grid1.DataSource = mc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, "配件批次", DateAdd(DateInterval.Month, -3, CDate(Format(Now, "yyyy/MM/dd"))), ">", Nothing, False, False, tesuvalue)
        LoadUserPower()
        Me.Text = Label1.Text
    End Sub
    Sub LoadUserPower()
        ...
        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010301")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationNew.Enabled = True
        End If


        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010302")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationEdit.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010303")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationDel.Enabled = True
        End If


        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010304")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationCheck.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010305")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationAccCheck.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010306")
        If pmwiL.Count > 0 Then
            If pmwiL.Item(0).PMWS_Value = "是" Then popQuotationSend.Enabled = True
        End If

        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010307")
        If pmwiL.Count > 0 Then
        ...
        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40010309")
        If pmwiL.Count > 0 Then
    ...
    Private Sub popQuotationDel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles popQuotationDel.Click
        ...
        If (IsDBNull(qi.Q_AccCheck) = True And IsDBNull(qi.Q_Check) = True) Or (qi.Q_AccCheck = False And qi.Q_Check = False) Then
            If MsgBox("確定要刪除編號為" & GridView2.GetFocusedRowCellValue("Q_QuoID").ToString & "的所有報價單嗎？", MsgBoxStyle.YesNo, "刪除提示") = MsgBoxResult.Yes Then
                ...
                Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, "配件批次", DateAdd(DateInterval.Month, -3, CDate(Format(Now, "yyyy/MM/dd"))), ">", Nothing, Nothing, Nothing, tesuvalue)
            End If
        Else
            MsgBox("此單已被審核，不允許刪除")
            Exit Sub
    ...
    Private Sub popQuotationSeek_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles popQuotationSeek.Click
        ...
        Select Case tempValue
            Case "1"
                Grid1.DataSource = qc.Quotation_Getlist(tempValue2, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, Nothing, tesuvalue)
            Case "2"
                Grid1.DataSource = qc.Quotation_Getlist(Nothing, tempValue2, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, Nothing, tesuvalue)
            Case "3"
                Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, tempValue2, Nothing, Nothing, tesuvalue)

            Case "4"
                If tempValue2 = "已審核" Then
                    Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, True, Nothing, tesuvalue)
                ElseIf tempValue2 = "未審核" Then
                    Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, False, Nothing, tesuvalue)
                End If
            Case "5"
                If tempValue2 = "已審核" Then
                    Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, True, tesuvalue)
                ElseIf tempValue2 = "未審核" Then
                    Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, False, tesuvalue)
                End If
            Case "6"
                Grid1.DataSource = qc.Quotation_Getlist(Nothing, tempValue2, Nothing, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, Nothing, tesuvalue)

            Case "7"
                Grid1.DataSource = qc.Quotation_Getlist(Nothing, Nothing, tempValue2, Nothing, "配件批次", Nothing, Nothing, Nothing, Nothing, Nothing, tesuvalue)

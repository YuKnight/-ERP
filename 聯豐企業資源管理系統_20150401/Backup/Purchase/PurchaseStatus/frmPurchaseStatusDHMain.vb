...
Public Class frmPurchaseStatusDHMain

    Private Sub frmPurchaseStatusDHMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Sub LoadPowerUser()
        ...
        pmwiL = pmws.PermissionModuleWarrantSub_GetList(InUserID, "40090101")

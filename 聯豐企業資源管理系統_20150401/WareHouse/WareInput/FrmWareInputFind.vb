...
Public Class FrmWareInputFind
    Dim mtc As New Material.MaterialTypeController

    Private Sub FrmWareInputFind_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If RadioButton3.Checked = True Then                 '編碼
            tempValue = "3"
            tempValue2 = TextEdit2.EditValue
        End If

        If RadioButton4.Checked = True Then                 '名稱
            tempValue = "4"
